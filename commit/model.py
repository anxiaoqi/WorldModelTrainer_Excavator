...
class LSTM(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers, lstm_output_size, lnn_input_size, lnn_hidden_size_1, lnn_hidden_size_2,
        ...
        self.fc_LNN_mid = nn.Linear(lnn_hidden_size_1, lnn_hidden_size_2)
        self.fc_LNN_out = nn.Linear(lnn_hidden_size_2, lnn_output_size)
    ...
    def forward(self, u, mid_x):
        ...
        lnn_hidden_2 = self.fc_relu(self.fc_LNN_mid(lnn_hidden_1))
        cal_next_x = self.fc_sigmoid(self.fc_LNN_out(lnn_hidden_2))
